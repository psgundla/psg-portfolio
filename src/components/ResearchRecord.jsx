...
export default function ResearchRecord() {
  return <div className="research-board">
    ...
    <header className="record-banner">
      <div><h2>Research in print &amp; in person</h2></div>
    </header>
    <div className="record-columns">
      <section className="record-papers" aria-labelledby="record-publications">
        <header><h3 id="record-publications">Publications</h3></header>
      ...
      <section className="record-events" aria-labelledby="record-events-title">
        <header><h3 id="record-events-title">Conferences, talks & posters</h3></header>
    ...
    <section className="record-achievements" aria-labelledby="record-awards"><header><h3 id="record-awards">Achievements</h3></header><div className="record-award-grid">
      <AchievementAward />
